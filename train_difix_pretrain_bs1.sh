...
export NUM_NODES=1
export NUM_GPUS=2
accelerate launch --mixed_precision=bf16 --main_process_port 29502 --multi_gpu --num_machines $NUM_NODES --num_processes $NUM_GPUS src/train_difix_pretrain.py \
    --output_dir=./outputs_bs1_pretrain/difix/train \
