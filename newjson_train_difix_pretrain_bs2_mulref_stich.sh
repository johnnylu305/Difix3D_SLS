export NUM_NODES=1
export NUM_GPUS=2
accelerate launch --mixed_precision=bf16 --main_process_port 29501 --multi_gpu --num_machines $NUM_NODES --num_processes $NUM_GPUS src/train_difix_pretrain_mulref.py \
    --output_dir=./outputs_newjson_bs2_pretrain_mulref_src_stich_no0.6_5e-5_curlr/difix/train \
